...
summary(model)
#Lastly, the help command was used to discover the units for Speed and Stopping Distance:
?cars
#Units 
...
#The first step here is to convert the existing values in the break distance (dist) from ft to miles in order to match units with speed, which is in miles per hour. A new variable is created for this converted value (dist_miles) where 1 foot is assumed as 0.000189394 miles.
